...
class GracefulShutdownHandler:
    ...
    def setup_signal_handlers(self) -> None:
        ...
        def signal_handler(signum: int, frame) -> None:
            ...
            logger.info(f"Received {signal_name} signal, initiating graceful shutdown", signal=signal_name)
        ...
        logger.info(f"Signal handlers registered for {self.service_name}", signals=["SIGTERM", "SIGINT"])
